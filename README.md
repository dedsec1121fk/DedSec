...
Files are saved in named folders like Camera-Phish etc,in your internal storage in the Download folder,use a file explorer to access them,also in this folder you must add images camera.jpg,record.jpg and locate.jpg to the login screens have your preferred background after the first use of them
