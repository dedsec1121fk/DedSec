...
9)DedSec Project Updater ensures your local files are always at the latest version of the project.😉

10)One Free SMS Per Day allows you to send one free ANONYMOUS message to any country,any number,one time everyday.😉
...
Files are saved in named folders like Camera-Phish etc,in your internal storage in the Download folder,use a file explorer to access them!
