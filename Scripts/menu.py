...
def categorize_scripts(scripts):
    ...
    for script in scripts:
        ...
        if "chat" in script_lower:
            categories["Anonymous Chatting"].append(script)
        elif "camera" in script_lower:
            categories["Camera Phishing"].append(script)
        elif "microphone" in script_lower:
            categories["Microphone Phishing"].append(script)
        elif "location" in script_lower:
            categories["Location Phishing"].append(script)
        else:
