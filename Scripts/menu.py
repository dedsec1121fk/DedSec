...
def categorize_scripts(scripts):
    categories = {
        "Chatting": [],
        "Hacking Using Login Pages": [],
        "Hacking Using Blank Pages": [],
        "Other Programs": []
    }
    ...
    for script in scripts:
        ...
        elif "login" in script_lower:
            categories["Hacking Using Login Pages"].append(script)
        elif "blank" in script_lower:
            categories["Hacking Using Blank Pages"].append(script)
        else:
