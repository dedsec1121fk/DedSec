...
def install_requirements():
    ...
    try:
        ...
        print(f"ERROR: Failed to install required Python packages.\n{e.stderr}")
        sys.exit(1)
    ...
    if not shutil.which("cloudflared"):
        ...
        if "linux" in sys.platform and os.path.exists("/data/data/com.termux"):
            ...
            print("Please install 'cloudflared' using your system's package manager.")
...
if __name__ == '__main__' and "--server" not in sys.argv:
    ...
    if VERBOSE_MODE: print("--- Running in Verbose Mode ---")
...
function initializeChat(secretKey) {
    ...
    function toggleFullscreen(videoElement) {
        ...
        if (videoElement) {
            ...
            closeBtn.onclick = () => toggleFullscreen(null); // Always close with null
    ...
    // FIX 1: VIDEO TOGGLE LISTENER RESTORED
