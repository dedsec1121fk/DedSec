...
if __name__ == '__main__':
    ...
    background_symlink = './static/background.jpg'
    if os.path.islink(background_symlink) or os.path.exists(background_symlink):
        os.remove(background_symlink)  # Remove the existing file or symlink

    os.symlink(BACKGROUND_IMAGE_PATH, background_symlink)  # Create new symlink
