...
# Modified the ASCII art to only display the title.
ASCII_ART_LINES = [
    "📻DedSec Radio📻"
]
...
def curses_main(stdscr):
    ...
    # Define a color pair for normal text: white text on default background.
    curses.init_pair(1, curses.COLOR_WHITE, -1)
    # Define a color pair for highlighted text (e.g., for selection): black text on white background.
    ...
    while True:
        ...
        # Render station names in the menu.
        ...
        # Draw currently playing song information.
