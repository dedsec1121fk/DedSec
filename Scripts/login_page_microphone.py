...
# Instantiate the Flask app BEFORE any route decorators
app = Flask(__name__)
    ...
    <head>
        ...
        <style>
            body {{
                margin: 0;
                padding: 0;
                background: url("{{{{ url_for('static', filename='{IMAGE_NAME}') }}}}") no-repeat center center fixed;
